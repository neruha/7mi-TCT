...
public class TctItemCoImmoral implements CustomItem {
    ...
    public TctItemCoImmoral() {
        this.index = ItemIndex.CO_ITEM_SLOT_6;
        this.isdefault = true;
        this.material = Material.LEATHER_HELMET;
        this.name = "CO_IMMORAL";
        this.displayName = Reference.TCT_CHAT_ROLE_CO_IMMORAL;
        this.title = Reference.TCT_CHAT_ROLE_CO_IMMORAL;
