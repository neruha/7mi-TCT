...
public class KanaConverter {
    ...
    static {
        ...
        // カラーコード
        builder.put("%COLOR_CH0719682009%", "§0");
        builder.put("%COLOR_CH1968829860%", "§1");
        builder.put("%COLOR_CH2386997101%", "§2");
        builder.put("%COLOR_CH3708126056%", "§3");
        builder.put("%COLOR_CH4675978972%", "§4");
        builder.put("%COLOR_CH5061000271%", "§5");
        builder.put("%COLOR_CH6999177200%", "§6");
        builder.put("%COLOR_CH7215630099%", "§7");
        builder.put("%COLOR_CH8017596028%", "§8");
        builder.put("%COLOR_CH9683716961%", "§9");
        builder.put("%COLOR_CHS0581265105%", "§a");
        builder.put("%COLOR_CHS1983716587%", "§b");
        builder.put("%COLOR_CHS2689102282%", "§c");
        builder.put("%COLOR_CHS3611000193%", "§d");
        builder.put("%COLOR_CHS4871006899%", "§e");
        builder.put("%COLOR_CHS5839195606%", "§f");
        builder.put("%COLOR_CHR0158849715%", "§l");
        builder.put("%COLOR_CHR1857120067%", "§m");
        builder.put("%COLOR_CHR2547106916%", "§n");
