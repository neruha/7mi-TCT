...
public class RoleVillager implements GameRole {
    ...
    public RoleVillager() {
        this.name = "VILLAGER";
        this.displayName = Reference.TCT_ROLE_VILLAGER;
        this.description = Reference.TCT_CHAT_ROLE_DESCRIPTION_VILLAGER;
        this.index = 0;
