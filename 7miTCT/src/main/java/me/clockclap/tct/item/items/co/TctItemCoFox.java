...
public class TctItemCoFox implements CustomItem {
    ...
    public TctItemCoFox() {
        this.index = ItemIndex.CO_ITEM_SLOT_5;
        this.isdefault = true;
        this.material = Material.LEATHER_HELMET;
        this.name = "CO_FOX";
        this.displayName = Reference.TCT_CHAT_ROLE_CO_FOX;
        this.title = Reference.TCT_CHAT_ROLE_CO_FOX;
