...
public final class Reference {
    ...
    public static final String TCT_CHAT_TELEPORTING = ChatColor.AQUA + "2秒後にテレポートします...";
    public static final String TCT_CHAT_SAVED_LOCATION = ChatColor.AQUA + "座標を記録しました";
    public static final String TCT_CHAT_ERROR_TELEPORTING = ChatColor.RED + "テレポート中です";
