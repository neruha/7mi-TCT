...
public class TctItemCoDetective implements CustomItem {
    ...
    public TctItemCoDetective() {
        this.index = ItemIndex.CO_ITEM_SLOT_1;
        this.isdefault = true;
        this.material = Material.LEATHER_HELMET;
        this.name = "CO_DETECTIVE";
        this.displayName = Reference.TCT_CHAT_ROLE_CO_DETECTIVE;
        this.title = Reference.TCT_CHAT_ROLE_CO_DETECTIVE;
