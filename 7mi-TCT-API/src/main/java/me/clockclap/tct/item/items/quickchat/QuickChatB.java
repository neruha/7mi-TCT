...
public class QuickChatB implements CustomSpecialItem {
    ...
    public QuickChatB() {
        this.index = ItemIndex.DEFAULT_ITEM_SLOT_6;
        this.isdefault = true;
        this.material = Material.STONE_HOE;
        this.name = "QUICKCHAT_B";
    ...
    public void onAttackPlayerWithCooldown(Player source, Player target) {
        PlayerData data = NanamiTctApi.game.getReference().PLAYERDATA.get(target.getUniqueId());
